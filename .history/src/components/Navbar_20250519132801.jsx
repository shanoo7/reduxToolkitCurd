  ...
  return (
    <nav className="bg-gray-800 text-white py-4 shadow-lg fixed top-0 left-0 w-full z-10">
      <div className="container mx-auto flex justify-between  px-4 lg:px-6">
        ...
        {/* Navigation Links */}
        <ul
          className={`lg:flex lg:gap-6 text-lg justify-center absolute lg:static top-16 left-0 w-full lg:w-auto bg-gray-800 lg:bg-transparent px-4 lg:px-0 py-4 lg:py-0 transition-all duration-300 ease-in-out z-40 ${
